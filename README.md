...
* **Testing & Quality:** pytest + ruff (linting, single-quote formatting)
...
The pipeline includes test coverage verifying file existence, DuckDB spatial schemas, non-null attribute contracts, and distance calculations:
